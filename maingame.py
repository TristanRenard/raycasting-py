...
def pausemenu(win,fullscreen):
    ...
    while True:
        ...
        resumebtn = pygame.image.load("./resumebtn.png")
        ...
        playbtn = pygame.image.load("./restart.png")
        ...
        homebtn = pygame.image.load("./homebtn.png")
        ...
        quitbtn = pygame.image.load("./quitbtn.png")
        ...
        if fullscreen == False:
            fullscreenbtn = pygame.image.load("./fullscreen.png")
...
def gamewin(win,screenwidth,screenheight, chrono,fullscreen):
    ...
    while True:
        ...
        winbanner = pygame.image.load("./winbanniere.png")
        ...
        restartbtn = pygame.image.load("./pagainbtn.png")
        ...
        exitbtn = pygame.image.load("./quitbtn.png")
